...
var UserServices = /** @class */ (function () {
    ...
    UserServices.Register = function (body) {
        return __awaiter(this, void 0, void 0, function () {
            var name, email, password, existingUser, encryptedPassword, user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        encryptedPassword = bcryptjs_1.default.hashSync(password, 1);
                        user = {
                            name: name,
                            email: email,
                    ...
                    case 2:
                        _a.sent();
                        return [2 /*return*/, { message: "Cadastro realizado com sucesso!" }];
                }
            });
        });
    };
    UserServices.Login = function (body) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    UserServices.AutoLogin = function (body) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                user = body.user;
